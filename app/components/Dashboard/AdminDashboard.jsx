  ...
  return (
    <>
        ...
        <div className="bg-yellow-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-yellow-600 dark:border-gray-600 text-white font-medium group">
          <div className="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="stroke-current text-yellow-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out"
            >
              <path
          ...
          <div className="rounded-t mb-0 px-0 border-0">
            <div className="flex flex-wrap items-center px-4 py-2">
              ...
              <div className="relative w-full max-w-full flex-grow flex-1 text-right">
                <button
                  className="bg-yellow-500 dark:bg-gray-100 text-white active:bg-yellow-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                  type="button"
                >
                  See all
                </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-4 gap-4 text-black dark:text-white">
        ...
        <Link href='/admin/approval'>  <h2 className="text-md font-bold text-center bg-[#f6820f] p-2 w-[300px]">View Waiting For Approval</h2></Link>
        </div>
            ...
            <div className="text-sm text-black dark:text-gray-50 mt-2 max-h-[390px] overflow-auto">
              ...
              {news?.map((news, index) => (
                ...
                >
                  ...
                  {/* View Button */}
                  <button
                    className="bg-yellow-500 text-white active:bg-yellow-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mt-2"
                    type="button"
                  >
                    View
                  </button>
          ...
          <span className="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
            <nav aria-label="Table navigation">
              <ul className="inline-flex items-center">
                ...
                <li>
                  <button className="px-3 py-1 text-white dark:text-gray-800 transition-colors duration-150 bg-yellow-600 dark:bg-gray-100 border border-r-0 border-yellow-600 dark:border-gray-100 rounded-md focus:outline-none focus:shadow-outline-yellow">
                    3
                  </button>
                </li>
                <li>
      ...
      <div className="mt-8 mx-4">
        <div className="p-4 bg-yellow-50 dark:bg-gray-800 dark:text-gray-50 border border-yellow-500 dark:border-gray-500 rounded-lg shadow-md">
          ...
          <ul>
            <li className="mt-3">
              <a
                className="flex items-center text-yellow-700 dark:text-gray-100"
