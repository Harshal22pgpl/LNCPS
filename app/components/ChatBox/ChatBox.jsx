...
//           />
//         </div>
//         <div className="h-12 w-12 p-2 bg-[#FF3344] rounded-full text-white font-semibold flex items-center justify-center">
//           RA
//         </div>
//       </div>
//       {/* Chatting */}
...
//               <div className="mr-2 py-3 px-4 bg-[#FF3344] rounded-bl-3xl rounded-tl-3xl rounded-tr-xl text-white">
